...
secondary_keywords:
  - eu 3 euro customs duty
  - eu 150 euro exemption removed
  - ioss ddp shipping china
  - eu low value parcel customs 2026
category: Shipping
audience: shopify
geo: eu
...
<script type="application/ld+json">
{
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://www.china-fulfillment.com/eu-de-minimis-2026-customs-duty-guide.html"
  }
}
</script>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "When does the EU €150 de minimis exemption end?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The EU Council agreed to remove the €150 customs duty exemption and levy a flat interim customs duty on low-value parcels from 1 July 2026, running until the full EU customs reform around 2028. The framework was agreed in late 2025 and given final approval in early 2026."
      }
    },
    {
      "@type": "Question",
      "name": "How is the €3 EU customs duty calculated?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The €3 interim duty applies per customs declaration line, meaning per distinct tariff (HS code) classification inside the parcel, not once per parcel. Two identical t-shirts count as one line and carry one €3 charge. One t-shirt plus one cap is two classifications and carries €6. The duty is also added to the taxable value before import VAT, so VAT is then charged on the higher total."
      }
    },
    {
      "@type": "Question",
      "name": "Why is DAP shipping risky after July 2026?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Under DAP (Delivered At Place) the carrier presents the duty and VAT bill to your customer before release. With every low-value parcel now carrying duty and VAT, DAP produces delivery rejections, carrier handling penalties, and chargebacks from buyers hit with a surprise doorstep charge. DDP (Delivered Duty Paid), where every cost is collected at checkout, is the only safe model."
      }
    },
    {
      "@type": "Question",
      "name": "What is IOSS and why does it matter for EU parcels?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "IOSS (Import One-Stop Shop) lets an overseas seller collect VAT and the interim duty at the point of sale and remit it centrally, so the parcel clears EU customs in a single scan rather than being routed into slow, expensive brokerage. An inactive or missing IOSS registration forces a hard fallback to legacy customs handling, with the customer footing a surprise bill."
      }
    },
    {
      "@type": "Question",
      "name": "How do I prepare my D2C brand for the July 2026 EU rules?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Assign precise HS codes to every SKU and group products that share a sub-heading, validate and re-link an active IOSS registration, switch your Shopify or WooCommerce checkout from DAP to a hard DDP model that injects the per-line duty into the customer's total, and transmit digital product identifiers plus the IOSS token on every parcel so it arrives pre-declared and clears in the green channel."
      }
    }
  ]
}
