---
title: "Incoterms for China Imports (2026): EXW vs FOB vs CIF vs DDP"
seo_title: "Incoterms for China Imports: EXW vs FOB vs CIF vs DDP"
meta_description: "EXW, FOB, CIF or DDP when importing from China? What each term actually covers, where risk transfers, the hidden costs, and which one suits you at which stage."
slug: incoterms-china-imports-exw-fob-cif-ddp
target_keyword: incoterms importing from china
secondary_keywords:
  - fob vs exw vs ddp china
  - cif vs fob china import
  - best incoterm for importing from china
  - incoterms 2020 explained ecommerce
category: Shipping
audience: shopify
geo: global
...
og_image: /images/blog/incoterms-china-imports-exw-fob-cif-ddp.webp
---
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "Incoterms for China Imports (2026): EXW vs FOB vs CIF vs DDP",
  "description": "A plain-English guide to the four Incoterms that matter when importing from China: what each covers, where risk and cost transfer, the charges that hide inside each one, and which term suits your stage.",
  "image": "https://www.china-fulfillment.com/images/blog/incoterms-china-imports-exw-fob-cif-ddp.webp",
  "author": {
    "@type": "Person",
    "name": "Noel Murphy",
...
# Incoterms for China Imports (2026): EXW vs FOB vs CIF vs DDP

![The handover points for EXW, FOB, CIF and DDP mapped across a China export journey from factory gate to port to the buyer's door](/images/blog/incoterms-china-imports-exw-fob-cif-ddp.webp)
...
## Why FOB is the usual right answer
...
And it gives you **control of the freight**, which is where the money is on a container. You choose the carrier, the routing and the destination agent. Our guide to [air, sea and express from China](/news-shipping-times-costs-china-2026.html) covers how much that choice actually moves the number, and our own [freight forwarding](/international-freight-forwarding-china.html) works this way for exactly that reason.

## Why EXW usually costs more than it looks
...
- Inland haulage from the factory to the port
...
![Incoterms for China imports: EXW hands over at the factory gate, FOB hands over loaded on the vessel with export cleared, CIF adds freight and minimum insurance to the destination port with risk still passing at origin, and DDP delivers to your door with duty paid](/images/blog/infographic-incoterms-handover-points.webp)

## Where CIF quietly costs you
...
## Why DDP is the right answer for parcels
...
That used to be a niche concern because low-value parcels often cleared free. It is not any more. [US de minimis has ended](/us-de-minimis-ended-2026-china-sellers-guide.html), so commercial parcels into the United States are proper customs entries. The [EU's low-value rules changed too](/eu-de-minimis-2026-customs-duty-guide.html), and other markets including [Japan](/china-to-japan-fulfillment-2026.html) are moving the same way. Parcels that once slipped through now owe something, and somebody has to pay it before the box reaches the doorstep.

We have a full explainer on [how DDP shipping from China works](/ddp-shipping-from-china-explained-2026.html), including what the quote should contain and what to check before you accept one.

The flip side: **DDP is usually the wrong term for a bulk container** into your own warehouse. You are paying a third party to make classification and valuation decisions on your behalf, on goods you know better than they do, with your name on the entry. Own that yourself. Our notes on [import duties, tariffs and landed cost](/news-import-duties-tariffs-landed-cost-china-2026.html) cover what you are actually taking on.
...
**Direct into a marketplace.** DDP or a properly structured FOB with your own broker, depending on whether you are shipping parcels or pallets. Our comparison of [shipping direct to FBA versus staging first](/amazon-fba-direct-vs-us-3pl-first-2026.html) covers how that decision interacts with the term you pick.

**Sourcing from several factories.** FOB into a [consolidation](/china-consolidation.html) point, so you combine suppliers into one clean shipment and one customs entry rather than paying for several.

## The thing Incoterms do not do
