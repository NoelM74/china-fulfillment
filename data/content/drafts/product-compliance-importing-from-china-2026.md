---
title: "Product Compliance for Importing from China (2026): CPC, FCC, CE and UKCA"
seo_title: "Product Compliance from China: CPC, FCC, CE and UKCA"
meta_description: "Which certificates does your China-made product actually need? CPC and CPSIA, FCC, CE and UKCA explained, plus the CPSC eFiling rule that started in July 2026."
slug: product-compliance-importing-from-china-2026
target_keyword: product compliance importing from china
secondary_keywords:
  - cpc certificate amazon china
  - fcc certification imported electronics
  - ce ukca marking china products
  - cpsc efiling 2026 importers
category: Operations
audience: amazon_fba
geo: global
...
og_image: /images/blog/product-compliance-importing-from-china-2026.webp
---
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "Product Compliance for Importing from China (2026): CPC, FCC, CE and UKCA",
  "description": "A practical guide to product compliance for sellers importing from China: CPC and CPSIA for children's products, FCC for electronics, CE and UKCA for Europe and Britain, and who is actually responsible for each.",
  "image": "https://www.china-fulfillment.com/images/blog/product-compliance-importing-from-china-2026.webp",
  "author": {
    "@type": "Person",
    "name": "Noel Murphy",
...
# Product Compliance for Importing from China (2026): CPC, FCC, CE and UKCA

![Compliance documents and test reports checked alongside China-made goods before export, covering CPC, FCC, CE and UKCA requirements in 2026](/images/blog/product-compliance-importing-from-china-2026.webp)
...
This is the general guide. We have covered compliance inside specific verticals before, [MoCRA for beauty](/china-to-us-fulfilment-beauty-skincare-brands.html), [FDA and FSVP for supplements](/china-fulfillment-supplements-nutraceutical-brands.html), [UN38.3 and dangerous goods for batteries](/shipping-batteries-electronics-from-china-2026.html), but plenty of sellers are in none of those categories and still have obligations.
...
## Children's products: CPC and CPSIA
...
## Electronics: FCC, and which route applies
...
Two practical points that follow. First, the FCC ID belongs to whoever holds the authorisation, which may be your module supplier rather than you, and the arrangement matters if you ever change factories. Second, if your product also contains a lithium battery, you are in [dangerous goods territory](/shipping-batteries-electronics-from-china-2026.html) as well, with UN38.3 test summaries and transport documentation on top of the FCC work.

![Product compliance by market for China-made goods in 2026: US children's products need a CPC from CPSC-accepted third-party lab testing with mandatory eFiling from 8 July 2026, wireless electronics need FCC Certification and non-wireless usually SDoC, the EU needs CE marking and a declaration of conformity, and Great Britain recognises CE indefinitely with UKCA required only for excluded categories](/images/blog/infographic-compliance-by-market.webp)
...
If you are shipping into the EU you also have VAT and IOSS obligations that sit alongside compliance and are equally yours. Our guides to [fulfilment into Germany and the EU](/china-to-germany-fulfillment-2026.html) and the [EU low-value rules](/eu-de-minimis-2026-customs-duty-guide.html) cover that side.

## Great Britain: UKCA, and why it matters less than it did
...
1. **Identify every market you will sell in** before you place a production order. Adding a market later can mean retesting.
2. **Ask an accredited lab or a compliance specialist what applies** to your specific product in those markets. Not your factory, and not a forum.
3. **Get testing done on production-representative samples**, not the prototype, and not a golden sample built by hand.
4. **Issue the certificate or declaration** yourself, or have your manufacturer issue it, based on the passing reports.
5. **Build the labelling and marking into the packaging artwork**, so it is applied at production rather than corrected later with stickers.
6. **Inspect against the approved specification** before shipping, because the compliance work is worthless if the goods that ship are not the goods that were tested. That is what [pre-shipment quality control](/quality-control-fba-prep-china.html) is for, and it is where a China-side partner earns its keep.
7. **Keep the documentation with the goods**, so it is available at entry rather than being hunted for while a container sits.

## Where we fit, and where we do not

We store your compliance documentation and make sure it travels with the shipment. We label and mark to the specification you supply. We inspect goods against your approved sample before they leave Shenzhen, which is how a mismatch between what was certified and what was made gets caught while it is still cheap. And we prep to your marketplace's specification so a documentary requirement does not turn into a rejection at the fulfilment centre, which is the same discipline behind our [FBA prep](/amazon-fba-prep-china.html) work.

We do not test, we do not certify, and we are not your importer of record. Those sit with you, your manufacturer and an accredited lab, and any [3PL that claims otherwise](/how-to-choose-a-china-3pl.html) is not a partner you want holding your stock.

## The bottom line

Compliance follows the product and the market, never the country of manufacture. Children's goods into the US need third-party lab testing and a CPC that you issue, now filed electronically at entry since 8 July 2026. Wireless electronics need FCC Certification, non-wireless usually the lighter SDoC route. The EU needs CE and a declaration of conformity, and Great Britain now recognises CE indefinitely for most categories. Sort it before production, verify against your own category rather than a summary, and keep the paperwork with the goods. [Tell us what you sell and where, and we'll make sure the documentation and labelling ship with it](/Contact-Us.html).
